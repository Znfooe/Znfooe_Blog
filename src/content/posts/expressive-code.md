...
description: 使用 Expressive Code 时，Markdown 中代码块的呈现效果。
tags: [Markdown, 博客, 演示]
category: 示例
draft: false
---

接下来，我们将一起探索使用 [Expressive Code](https://expressive-code.com/) 时，Markdown 中的代码块会有怎样的呈现效果。文中的示例均出自其官方文档，如需了解更多细节，可直接查阅该文档。
